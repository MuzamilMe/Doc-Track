        ...
        <form action="Appointment" method="post" class="appointment-form ftco-animate align-items-center">
          ...
          <div class="d-md-flex">
            ...
            <div class="form-group ml-md-4">
              <input type="text" name="last_name" class="form-control p-1" placeholder="Last Name">
            </div>
          </div>
          <div class="d-md-flex">
            <div class="form-group">
              <div class="form-field">
                ...
                <input type="text" name="Doctor" class="form-control p-1" placeholder="Doctor's Name">
              </div>
            </div>
          </div>
           <%--Selector for deaprtment--%>
          <div class="d-md-flex">
            <div class="form-group" >
              <div class="form-field" >
                <div class="select-wrap"  >
                  ...
                  <select     name="Service"  class="form-control"  required>
                    ...
                    <option   value="Opthomology">Ophthalmology</option>
          ...
          <div class="icon"><span class="ion-ios"></span>
            <input type="number" name="Phone" class="form-control p-1 " placeholder="Phone">
          </div>
          <div class="icon"><span class="ion-ios"></span>
            <input type="text" name="message" class="form-control p-1" placeholder="Message">
          </div>
