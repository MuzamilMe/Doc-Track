...
(
    OBJECT_TYPE      varchar(64)     null comment 'TABLE in the case of all indexes.',
    OBJECT_SCHEMA    varchar(64)     null comment 'Schema name.',
    OBJECT_NAME      varchar(64)     null comment 'Table name.',
    INDEX_NAME       varchar(64)     null comment 'Index name, or PRIMARY for the primary index, NULL for no index (inserts are counted in this case).',
