            ...
            <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        ...
                        <p>Where Expertise Meets Compassion, Connecting You with Trusted Doctors for Your Optimal Care</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        ...
                        <p>Urgent Care, Rapid Response. When Every Second Counts, Our Dedicated Team is Here to Safeguard Your Well-being.</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading">Medical prescription</h3>
                        <p>Your Well-being is Our Priority, and Each Prescription is Crafted with Your Unique Needs in Mind</p>
                    </div>
                </div>
            </div>
            <div class="col-md-3 d-flex services align-self-stretch p-4 ftco-animate">
                <div class="media block-6 d-block text-center">
                    ...
                    <div class="media-body p-2 mt-3">
                        <h3 class="heading">Taking Appointments</h3>
                        <p>Simple Booking at Your Fingertips Take the First Step Towards Prioritizing Your Health and Book Your Appointment Today</p>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row no-gutters">
            ...
            <div class="col-md-7 wrap-about py-4 py-md-5 ftco-animate">
                ...
                <div class="pl-md-5 ml-md-5 mb-5">
                    <p>You are seeking acute care, chronic condition management, or simply need a prescription refill, our Website is your reliable partner in health. Embrace the future of healthcare with us, and experience the convenience, expertise, and compassion that define our services. Your health is our commitment, and we're here to guide you every step of the way. Start your journey towards optimal health today by scheduling an appointment with us.</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 d-flex align-items-center">
                <p class="mb-0"><a href="appointment.jsp" class="btn btn-secondary px-4 py-3">Consutation</a></p>
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
            <div class="col-md-8 text-center heading-section ftco-animate">
                ...
                <p>Introducing our team of qualified doctors, where expertise meets compassion. Our dedicated professionals are here to guide you on your journey to optimal health with their extensive knowledge and unwavering commitment.</p>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        <div class="row justify-content-center mb-5 pb-2">
            <div class="col-md-8 text-center heading-section ftco-animate">
                ...
                <p>These doctors have been a lifeline for our family. Their expertise and unwavering support have made a world of difference in our health journey. We couldn't have asked for better care.</p>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4 ftco-animate">
                <div class="blog-entry">
                    ...
                    <div class="text bg-white p-4">
                        <h3 class="heading"><a href="#">Scary Thing That You Don’t Get Enough Sleep</a></h3>
                        <p>Empowering Your Health, One Click at a Time. Book Your Wellness Journey Today!</p>
                        <div class="d-flex align-items-center mt-4">
                            <p class="mb-0"><a href="#" class="btn btn-primary">Read More <span class="ion-ios-arrow-round-forward"></span></a></p>
                            <p class="ml-auto mb-0">
                                <a href="#" class="mr-2">Admin</a>
